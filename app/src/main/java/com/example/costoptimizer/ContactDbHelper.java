...
public class ContactDbHelper extends SQLiteOpenHelper {
    ...
    public List<PurchaseModel> getAllPurchases(SQLiteDatabase db) {
        List<PurchaseModel> purchases = new ArrayList<PurchaseModel>();
        Cursor cursor = this.readPurchase(db);
        ...
        while (cursor.moveToNext()) {
            ...
            PurchaseModel purchase = new PurchaseModel(id, name, quantity, date, store, cost);
